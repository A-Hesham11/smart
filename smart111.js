...
let allLinks = document.querySelector(".header .links");
let icon = document.querySelector(".header .fa-bars");

icon.onclick = function() {
    allLinks.classList.toggle("toggle-show")
};
...
// Add Cart Box On Local Storage
let cartLocalItems = localStorage.getItem("cart_local");
let buttonBuy = document.getElementsByClassName("button-buy");
...
// Create The Product Box
    for (let i = 0; i < obj.length; i++) {
        ...
        buttonCart.className = "button-cart";
        ...
        buttonCart.onclick = function() {
            ...
            buttonBuy.addEventListener("click", (e) => {
                ...
                localStorage.setItem("cart_local", buttonCpmolete.style.left);
            });
